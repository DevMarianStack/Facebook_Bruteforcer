...
==================================\n"""+wi)
    ...
    def updateFacebook_hack():
        ...
        conn.request("GET", "/DevMarianStack/Facebook_Bruteforcer/main/core/version.txt")
        ...
        if repoVersion == currentVersion:
            ...
            conn.request("GET", "/DevMarianStack/Facebook_Bruteforcer/main/facebook_hack.py")
    ...
    if update:
        ...
        for passwd in passwords:
            ...
            if retCode:
                ...
                print(wi+"========================="+"="*len(passwd)+"======")
                if retCode == 2: print(wi+"["+yl+"!"+wi+"]"+yl+" Warning: This account uses ("+rd+"2F Authentication"+yl+"):"+rd+" It's Locked"+yl+" !!!")
                break
            else:
